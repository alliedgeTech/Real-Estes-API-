...
exports.createGalleryItem = async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ message: "Error creating gallery item: " + err.message });
  }
};
...
exports.getGalleryItems = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching gallery items: " + err.message });
  }
};
...
exports.getGalleryItemById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error fetching gallery item: " + err.message });
  }
};
...
exports.updateGalleryItem = async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ message: "Error updating gallery item: " + err.message });
  }
};
...
exports.deleteGalleryItem = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error deleting gallery item: " + err.message });
  }
};
